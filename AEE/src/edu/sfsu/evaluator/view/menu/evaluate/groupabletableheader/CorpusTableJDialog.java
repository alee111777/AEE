...
public class CorpusTableJDialog extends JDialog
{
    ...
    public CorpusTableJDialog(Vector<Vector<String>> newCorpusData,
                              Vector<Vector<String>> newMentionData,
                              Vector<String> newMentionNameList)
    {
        super();
        this.setTitle("Corpus Evaluation Data");
    ...
    public static void main(String[] args)
    {
        ...
        new CorpusTableJDialog(corpusData, mentionData, mentionNameList);
